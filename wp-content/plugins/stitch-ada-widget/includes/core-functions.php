...
function myplugin_enqueue_style_public() {
	...
	*/
	...
	$src = plugin_dir_url( dirname( __FILE__ ) ) .'public/css/stitched-public.css';

	wp_enqueue_style( 'stitched-public', $src, array(), null, 'all' );
...
function myplugin_enqueue_script_public() {
	...
	*/
	...
	$src = plugin_dir_url( dirname( __FILE__ ) ) .'public/js/stitched-public-min.js';

	wp_enqueue_script( 'stitched-public', $src, array(), null, false );
